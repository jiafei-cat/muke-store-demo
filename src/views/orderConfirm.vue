                    ...
                    <div class="checkout-order">
                            ...
                            <div class="price-count">
                                <ul>
                                    <li>
                                        ...
                                        <span>${{ totalMoney | currency('', 2) }}</span>
                                    </li>
                                    <li>
                                        <span>Shipping:</span>
                                        <span>$0</span>
                        ...
                        <div class="order-foot-wrap">
                            <div class="prev-btn-wrap">
                                <button class="btn btn--m" @click="$router.push({path: '/address'})">Previous</button>
                            </div>
...
<script>
import { _cartList, _payMent } from '../service/service'
export default {
    data() {
        return {
            addressId: '',
    ...
    methods: {
        async getCartList() {
            ...
            this.productList = res.data.result.filter((i) => {
                return i.checked === '1'
            })
        },
        async pay() {
